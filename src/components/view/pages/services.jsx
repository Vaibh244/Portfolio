...
export default function services({ id }) {
  return (
    <>
      <div
        id={id}
        className="text-center w-full text-2xl my-2  text-brandLight dark:text-yellow-800"
      >
        <p>What I Do ?</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center md:justify-between items-center text-center pb-36 ">
        ...
        <div className=" p-6 max-w-sm rounded-2xl overflow-hidden shadow-3xl border bg-white hover:shadow-2xl transition-shadow duration-300 group cursor-pointer">
          <div className="p-6 flex flex-col items-center transition-all duration-300">
            ...
            <p className="text-gray-600 text-sm mb-0 max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 overflow-hidden transition-all duration-500 text-center">
              I create fast, interactive user interfaces using modern
              technologies like React, JavaScript, and TailwindCSS.
            </p>
          </div>
        </div>
        ...
        <div className=" p-6 max-w-sm rounded-2xl overflow-hidden shadow-3xl border bg-white hover:shadow-2xl transition-shadow duration-300 group cursor-pointer">
          <div className="p-6 flex flex-col items-center transition-all duration-300">
            ...
            <p className="text-gray-600 text-sm mb-0 max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 overflow-hidden transition-all duration-500 text-center">
              I translate UI/UX designs into clean, functional code that aligns
